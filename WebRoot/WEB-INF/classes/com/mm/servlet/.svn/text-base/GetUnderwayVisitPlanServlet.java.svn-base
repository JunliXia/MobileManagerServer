...
public class GetUnderwayVisitPlanServlet extends HttpServlet {
	...
	public void service(HttpServletRequest request, HttpServletResponse response)
		...
		CEntityVisitPlanArray cEntityVisitPlanArray=iBllFrame.GetUnderwayVisitPlan(cEntityEmployee);
