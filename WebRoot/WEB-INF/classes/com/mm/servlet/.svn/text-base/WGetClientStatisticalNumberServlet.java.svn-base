...
public class WGetClientStatisticalNumberServlet extends HttpServlet {
	...
	public void service(HttpServletRequest request, HttpServletResponse response)
		...
		List findResult=iBllFrame.getClientStatisticalNumber();
		...
		while (it.hasNext()) {       
			...
			outjson.put("ClientNumber", (Long)tuple[3]);
