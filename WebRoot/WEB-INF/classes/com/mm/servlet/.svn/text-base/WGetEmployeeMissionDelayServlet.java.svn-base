...
public class WGetEmployeeMissionDelayServlet extends HttpServlet {
	...
	public void service(HttpServletRequest request, HttpServletResponse response)
		...
		LinkedMap findResult=iBllFrame.GetEmployeeMissionDelay(cEntityEmployee);
		...
		while(ite.hasNext()){
			...
			jsonArray.add(toJSON(cEntityMissionDelay,cEntityMission));
		}
	...
	private JSONObject toJSON(CEntityMissionDelay cEntityMissionDelay,CEntityMission cEntityMission){
