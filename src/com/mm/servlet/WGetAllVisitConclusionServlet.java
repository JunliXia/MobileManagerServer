...
public class WGetAllVisitConclusionServlet extends HttpServlet {
	...
	public void service(HttpServletRequest request, HttpServletResponse response)
		...
		LinkedMap findResult=iBllFrame.getAllVisitConclusionInfo();
		...
		while(ite.hasNext()){
			...
			jsonArray.add(toJson(cEntityEmployee, cEntityClient,cEntityVisitPlan,cEntityVisitConclusion));
	...
	private JSONObject toJson(CEntityEmployee cEntityEmployee,CEntityClient cEntityClient,CEntityVisitPlan cEntityVisitPlan,CEntityVisitConclusion cEntityVisitConclusion){
		JSONObject js=new CEntityVisitConclusion.BuildJsonObject().ToSingle(cEntityVisitConclusion).build();
