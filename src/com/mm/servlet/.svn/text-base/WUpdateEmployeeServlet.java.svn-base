...
public class WUpdateEmployeeServlet extends HttpServlet {
	...
	public void service(HttpServletRequest request, HttpServletResponse response)
		...
		CEntityEmployee cEntityEmployee=new CEntityEmployee.Builder().EmployeeId(EmployeeId).EmployeeName(EmployeeName).EmployeePassword(EmployeePassword).
		...
		boolean bisUpdate=iBllFrame.updateEmployee(cEntityEmployee);
		
		JSONObject outjson=new CEntityAdministrator.BuildJsonObject().Check(bisUpdate).build();
