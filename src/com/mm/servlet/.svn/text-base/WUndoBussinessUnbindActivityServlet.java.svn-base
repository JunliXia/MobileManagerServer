...
public class WUndoBussinessUnbindActivityServlet extends HttpServlet {
	...
	public void service(HttpServletRequest request, HttpServletResponse response)
		...
		boolean bisUndo=iBllFrame.undoBussinessWithUnbindBussinessActivity(cEntityBussiness, cEntityBussinessUndo);
