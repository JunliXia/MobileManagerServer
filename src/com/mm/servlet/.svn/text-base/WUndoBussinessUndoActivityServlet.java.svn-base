...
public class WUndoBussinessUndoActivityServlet extends HttpServlet {
	...
	public void service(HttpServletRequest request, HttpServletResponse response)
		...
		boolean bisUndo=iBllFrame.undoBussinessWithUndoBussinessActivity(cEntityBussiness, cEntityBussinessUndo);
