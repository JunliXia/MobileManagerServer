...
//				.getcEntityClient().getM_iClientState());
		outjson.put(MyOpcode.Client.ClientId,1);
		outjson.put(MyOpcode.Client.ClientName,"22");
		outjson.put(MyOpcode.Client.ClientCompany, "222");
		outjson.put(MyOpcode.Client.ClientPhone, "222");
		outjson.put(MyOpcode.Client.ClientArea, "222");
		outjson.put(MyOpcode.Client.ClientAddress,"222");
		outjson.put(MyOpcode.Client.ClientState, 1);
